...
- Using any emulator features which give a meaningful advantage over someone playing on console are banned.
  These include, but are not limited to, save states, custom macros, and pausing execution or advancing frames.

## Settings

Settings string:<br/>
`1sA192koP_yViP8Hv_zEZtdgug3_6eC3LAPe5S8o0FiywyEMuYwXRvI_9xWzbtL0SzfjMiCD5J8R_W`
