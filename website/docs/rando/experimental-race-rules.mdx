...
- Hints
  ...
  - Hint distribution: 2 Spirit of Light, 2 Barren, 4 Always, 4 Sometimes, and AgithaRewards.
    ...
    - For more information on Hints, please visit the Hints Page. // TODO: create page
- Excluded Checks
...
- non-small chests is 24 checks, 10 immediately available.

Having 30 checks is kind of just too much (the most in the game for "one area").

So then comparing the non-poe and non-small chest approaches, we can see that the total number of checks is pretty similar 22 vs 24.

The difference is that with non-poes 16/22 (73%) checks are immediately available, whereas with non-small chests only 10/24 (42%) are immediately available.
