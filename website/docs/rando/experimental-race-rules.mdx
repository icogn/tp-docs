...
- **Take note of the following exclusions!**
  ...
  - 12 Agitha checks (bugs for excluded checks not in item pool; you can't find them)
    - Check the `AgithaRewards` hints!
  - Poes:
    - Sphere 0 poes (any you can logically access at the very start of the seed, 24 total)
    - Snowboarding Poe outside Snowpeak Ruins
...
- Timesavers - everything but `Increase Spinner Speed`
- Additional Settings - everything but Trap (Foolish) Items
- Dungeon Entrances:
  - Goron Mines - Open
  - Lakebed Temple requires Water Bombs to enter.
    Clipping into the dungeon is BANNED.
...
- You can view the hints before the race.
- Hint distribution:
  ...
  - 4 Always
    ...
    - Checks: `Goron Springwater Rush, Iza Helping Hand, Jovani 20 Poe Soul Reward, Lanayru Ice Block Puzzle Cave Chest`
  - 4 Sometimes
    - Tells you the exact reward for certain checks.
  - AgithaRewards
...
- All Timesavers and "Additional Settings" are checked.
- Trap (Foolish) Items are turned OFF.
- Dungeons:
  - Forest Temple
    - Faron Woods Logic is Open, so you can access Hyrule Field without completing Forest Temple.
  - Goron Mines
    - Set to Open.
  ...
  - Lakebed Temple
    - You will need to use Water Bombs to open the entrance.
      You start with Zora Armor to lessen the requirements to enter the dungeon.
      Going out of bounds to access the dungeon is banned!
  - Arbiter's Grounds
  ...
  - Hyrule Castle
    ...
    - To beat the dungeon, you will need the Master Sword (find 3 of 4 swords), Double Clawshots, Boomerang, and Spinner.
      ...
      You will also need either Bow or Ball and Chain to beat Beast Ganon.
- Starting Inventory
  ...
  - Start with one Fishing Rod, Zora Armor, and all but one Sky Character.
    These are all meant to reduce the requirements to enter dungeons but still preventing the dungeons from being accessible right from the start.
- Hints
  - Hints are available on the seed page from which you download the seed GCI.
    Scroll down some and click the Hint tab.
  - Hint distribution: 2 Spirit of Light, 2 Barren, 4 Always, 4 Sometimes, and AgithaRewards.
    ...
    - The Always and Sometimes hints will tell you the exact Rewards given by the selected Checks.
      - Always hints: `Goron Springwater Rush, Iza Helping Hand, Jovani 20 Poe Soul Reward, Lanayru Ice Block Puzzle Cave Chest`
    - The AgithaRewards hint tells you all meaningful items which Agitha can give out.
      Note that there are only 12 bugs in the item pool (you can only find up to 12 bugs).
...
- Excluded Checks
  ...
  - Agitha has 12 of her rewards excluded.
    The 12 bugs which would lead to these excluded checks are not in the Item Pool, so any bug you find can potentially be useful.
    Read the AgithaRewards hint to know which items she can give out.
  - Poes
    - Excluded
      - 29 of the 60 poes are excluded.
      ...
      - The only other Poe which is excluded is the one outside Snowpeak Ruins so that you don't have to worry about snowboarding when Snowpeak Ruins is not a required dungeon.
    - Included
      ...
      - The other 20 overworld poes are divided as follows:
        ...
        - 4 in Snowpeak (5 but we subtract 1 for the Poe outside Snowpeak Ruins).
      ...
      - Included Poes Summary
        - 11 dungeon
        - 20 overworld
          - 8 desert area, 4 snowpeak, 3 hype cave, 2 sacred grove, 1 kak gorge cave, 1 great bridge of hylia, 1 death mountain (Goron Mines seeds only)
  - Desert chests
...
- Banned Glitches/Tricks
  - Back in Time, Boss Key Skips, Iza Item Manipulation, Early Monkey Chain Room (entering room before boss without boomerang), Hyrule Castle Required Item skips (double clawshots, spinner, boomerang), Skipping Reekfish Scent, and Clipping into Lakebed Temple.
- Rulings
  - You are allowed to use Magic Armor with 0 rupees where you might use Iron Boots.
  - In Hyrule Castle, any method of hitting the switch in the room before the double Darknuts is allowed.
...
- Only 12 of the bugs are included instead of 24.
- The 12 bugs which lead to excluded rewards are left out of the Item Pool.
...
- Snowpeak which usually only has 2 non-Poe checks gets another 4 checks (5 poes minus 1 excluded poe outside the dungeon).
  This makes it a much better place to visit, especially when Snowpeak Ruins is not a required dungeon.
- Other areas which gain a small number of checks thanks to Poes can fight for attention a little better.
- Hype cave can be a little risker with low resources since you will find more poe souls.
- If Jovani has something good, you do not have to spend several minutes on hunting poes.
...
The Poe outside snowpeak is excluded so that you don't have to worry about snowboarding when Snowpeak Ruins is not required.
...
Iron Boots are a required item for Lakebed Temple and City in the Sky as well, so there is a good chance you can find Iron Boots fairly early depending on which dungeons are required.
