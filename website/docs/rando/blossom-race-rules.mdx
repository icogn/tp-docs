...
- The next priority is completing sphere0 checks and gathering hints.
  ...
  - While you are still determining the other 2 zones which are hinted barren (3 total hinted-barren zones; 1 of the 3 is a starting hint), checking the hint sign in a zone should be one of the first things you do there.
...
- If you find a hint related to bugs, then you know that Agitha is not barren.
  At some point you will want to go check the Agitha hint which tells all Good items she rewards.
