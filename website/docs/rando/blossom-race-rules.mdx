...
- The next priority is completing sphere0 checks and gathering hints.
  ...
  - While you are still determining the other 2 zones which are hinted barren (3 total barren-hinted zones; 1 of the 3 is a starting hint), checking the hint sign in a zone should be one of the first things you do there.
    A zone's sign will _ALWAYS ALWAYS ALWAYS_ indicate whether or not that zone is hinted barren.
...
- 5 Always hints (2 checks hinted per sign; find 3 or 4 of 5 signs to get all hints)
...
- TradeGroup hint
  ...
  - Ex: "They say that bring {male bugs} to Agitha leads to nothing."
- Item hint
...
- Boss Heart Container Woth hints
  ...
  - This is meant to be an "oh snap" moment.
...
When the big key is on a trade reward, you will instead get a TradeChain hint toward the check that starts the chain ending the big key.
...
- {Something good} can be found beyond this point.
  - There is at least Good check beyond this point.
