...
<CopyTextComp text="5sQ2h2kPC_-CfeJ8HaX7cJny-NoZKQZKmwNIwNIwNIu70u70u70u70u70u70u70uF-dHwhiQWwbCq307sUTU72BgCfPHjsCLFvNVazQk3sNSZkAcAH4eq3alOmoiJR1tmg5hqKqqp99Yw7OG2tyeq1KEqsZBrkttBM69sqHGff3dqD_m" />

- <a
    target="_blank"
    href="/spoilerLogs/Tpr--PositiveEpona_wsr--SpoilerLog-ogiovoAb3oh.json"
    download
  >
...
- 2 Barren Zone hints
  - Note that a maximum of 1 dungeon can be hinted barren.
...
- 1 Required Item hint
- 1 Basic Item hint
- Either 1 Barren Category hint or 1 Barren Bug Gender hint
...
- Basic Item hint
  - This hint is for one of the following items: Bomb Bag, Bow, or Fishing Rod.
  - The item is not guaranteed to be required, and the hint text never indicates if that specific item is required.
  - There is a slight preference for hinting fishing rods when they are required (such as seeds with Snowpeak Ruins), but the item hinted by this hint is NOT guaranteed to be required.
  - This hint is intentionally not as strong as some of the other hints for balance purposes.
  - Ex: "They say that a {bow} can be found in the {Gerudo Desert}."
  - Ex: "They say that a {fishing rod} can be found in {Faron Woods}."
- TradeGroup (barren bug gender) hint
...
- BarrenCategory hint
  ...
  - Ex: "They say that there is nothing to be found in the {2 lantern chests in Lake Lantern Cave}."
...
- Snowpeak Ruins
  ...
  - This hint has a slight preference for hinting checks which are Good or Required.
