...
<CopyTextComp text="5s22f2kPS_-CfeJ8HaX7cJny-NoZKQZNIwNIwNIwN0u70u70u70u70u70u70u71_qwFUUhYeFyQWpphmvRYBg5lbBADknYf_AxydhLmUoxaTnKnI8b6WSbx66LYROE-5GjUYcccP9CNGx20M_b6WAXscqPUjs-vQmnEsYA5D8S-Xl-" />

- <Link to="https://www.youtube.com/watch?v=2Ihj2hD4ElM">
...
- Item Pool
  ...
  - The following are shuffled and included:
    - Sky Characters
    - Gifts from NPCs
  - The following are shuffled, but the source checks are excluded:
    - Golden Bugs
    - Hidden Skills
    - Shop Items
...
- Starting Inventory
  ...
  - General:
    ...
    - 15 Poe Souls
  - Dungeons:
    - 6 Progressive Sky Books (missing 1 character)
