...
The index of the first TP save data block on the memory card. This value should always be at least 0x0005 since the first 5 blocks are used to manage the filesystem.
